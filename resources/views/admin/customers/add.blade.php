                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                id="exampleFormControlName" placeholder="Enter Name" value="{{old('name')}}">
                                            @if ($errors->has('name'))
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" name="email"
                                                id="exampleFormControlInput2" placeholder="Enter Email" value="{{old('email')}}">
                                            @if ($errors->has('email'))
                                                <div class="text-danger small mt-1">
                                                    {{ $errors->first('email') }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="client_type" id="exampleFormControlSelect12">
                                                ...
                                                <option {{ old('client_type') == 'alcon' ? "selected" : "" }} value="alcon">Alcon</option>
                                                <option {{ old('client_type') == 'other' ? "selected" : "" }} value="other">Other</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="contact_no"
                                                id="exampleFormControlSelect12" placeholder="Contact No" value="{{old('contact_no')}}">
